const capabilities = [
  {
    ...
    iconColor: 'text-cyan',
    glow: 'hover:shadow-[0_12px_40px_rgba(0,232,255,0.12)] hover:border-cyan/40',
  ...
  },
  {
    ...
    iconColor: 'text-blue',
    glow: 'hover:shadow-[0_12px_40px_rgba(45,107,255,0.12)] hover:border-blue/40',
...
export default function Capabilities() {
  return (
    <section id="capabilities" className="px-8 py-24">
